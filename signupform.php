...
<input type="hidden" name="postedfrom" value="members">
<label>Email address: </label><input name="email" type="text" class="text" id="email" placeholder="Email address"><br>
...
<label>First Name: </label><input name="firstname" type="text" class="text" id="firstname"><br>
<label>Last Name: </label><input name="lastname" type="text" class="text" id="lastname"><br>
<label>Street Address: </label><input name="address" type="text" class="text" id="address"><br>
<label>City: </label><input name="city" type="text" class="text" id="city"><br>
<label>State/Province: </label><input name="state" type="text" class="text" id="state"><br>
    <label>Postal/Zip Code: </label><input name="postal" type="text" class="text" id="postal"><br>
    <label>Country: </label>
  <select name="Country" id="country-selector" autofocus autocorrect="off" autocomplete="off">
...
<br><br>
<label></label><input type="submit" class="aabtn" value="Update">
</form>
